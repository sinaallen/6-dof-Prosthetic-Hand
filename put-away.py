## Felix Wilton
## Feb 20th, 2025
## Cycles all 5  actuators to 0 position to put them away
...
if __name__ == '__main__':
    ...
    time.sleep(1)
    print('Setting positions for all 5 actuators in broadcast mode to zero!')
    broadcast(serialPort, 6, 0, 0, 0, 0, 0, 0)
    time.sleep(1)
